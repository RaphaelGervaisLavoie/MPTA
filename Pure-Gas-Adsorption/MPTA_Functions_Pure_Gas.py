...
This file provide the functions used in the implementation of the MPTA for pure gas.
 ...
 If you find this code usefull, please cite the folowing reference:
   ...
   title={Numerical implementation of the multicomponent potential theory of adsorption in  
          Python using the NIST Refprop database},
   author={Lavoie, Rapha{\"e}l Gervais and Ouellet, Mathieu and Hamelin, Jean and 
           B{\'e}nard, Pierre},
